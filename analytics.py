...
# -----------------------------------------------------------------------------
# Ejecución principal (versión main — modo producción)
# -----------------------------------------------------------------------------

if __name__ == "__main__":
    print("[main] Modo producción activo.")
    print(f"  - Región configurada: {REGION_FILTRO}\n")

    ventas, clientes = cargar_datos(RUTA_CSV, RUTA_JSON)

    if ventas is not None and clientes is not None:
        print("[main] Datos cargados. Modo producción activo.")
        print(f"  - Región configurada: {REGION_FILTRO}")
    else:
        print("[main] Error crítico: datos no disponibles. Abortar.")
